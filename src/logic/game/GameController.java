...
public class GameController {
    ...
    public void endDay() throws BadStatusException {
        for (int i = 0 ; i < this.players.size() ; i++) {
            int a = this.players.get(i).getEnergy() - 3 ;
            this.players.get(i).setEnergy(this.players.get(i).getEnergy() - 3);
            if (a < 0) {
                this.players.get(i).getStatus().setHp(this.players.get(i).getStatus().getHp() + a);
                this.players.get(i).setEnergy(0);
            }
            if (this.players.get(i).getStatus().getHp() < 0) {
                this.players.get(i).getStatus().setHp(0);
            }
        }
    }
